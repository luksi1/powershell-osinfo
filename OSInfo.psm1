...
function Get-ServiceInformation {
     ...
     # servicename, displayname, startuptype, serviceaccount
     begin { New-CimSession -ComputerName $ComputerName }

     process {

         Get-CimSession | Get-CimInstance Win32_Service -PipelineVariable services | 
         Select-Object -Property `
            @{N='ComputerName'; E={$ComputerName}},
            DisplayName,
            @{N='ServiceName'; E={$services.Name}}, 
            @{N='StartupType'; E={$services.StartMode}}, 
            @{N='ServiceAccount'; E={$services.StartName}},
            Status,
            State,
            Description
     }
...
function Get-DiskInformation {
     ...
     process {
         Get-CimSession | Get-CimInstance Win32_logicaldisk | 
